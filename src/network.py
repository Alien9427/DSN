...
class SLC_joint2(nn.Module):
    def __init__(self, img_feat_max=5.859713554382324, num_classes=5):
        ...
        self.img_feat_max = img_feat_max
    ...
    def forward(self, x_spe, x_img):
        ...
        x_img = x_img / self.img_feat_max # img after tsx.pth feature max value
        # x_spe = x_spe / 0.18485471606254578 # spe_3d max value
        # print('x_spe_max: ', x_spe.max())
        # print('x_img_max: ', x_img.max())
